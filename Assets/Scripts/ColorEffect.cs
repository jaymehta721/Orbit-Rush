...
public class ColorEffect : MonoBehaviour
{
    ...
    public static readonly Color[][] ThemeColors =
    {
        ...
        new Color[] {new Color(0.113f, 0.217f, 0.288f), new Color(0.988f, 0.894f, 0.925f)}, // 2
        ...
        new Color[] {new Color(0.311f, 0.662f, 0.156f), new Color(0.882f, 0.960f, 0.996f)}, // 7
        new Color[] {new Color(0.220f, 0.880f, 0.510f), new Color(0.878f, 0.968f, 0.980f)},     // 8
